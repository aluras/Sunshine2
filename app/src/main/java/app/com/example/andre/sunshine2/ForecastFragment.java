...
public class ForecastFragment extends Fragment {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id== R.id.action_refresh){
           new FetchWeatherTask().execute("santos,br");
            return true;
        }
    ...
    public class FetchWeatherTask extends AsyncTask<String,Void,String[]>{
        ...
        protected String[] doInBackground(String... params) {
            ...
            try {
                ...
                builtUri.appendQueryParameter(PERIOD_PARAM, Integer.toString(period));
                ...
                //URL url = new URL("http://api.openweathermap.org/data/2.5/forecast/daily?q=santos,br&mode=json&units=metric&cnt=7");

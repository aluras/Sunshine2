...
public class ForecastAdapter extends CursorAdapter {
    ...
    private String formatHighLows(double high, double low) {
        ...
        String highLowStr = app.com.example.andre.sunshine2.Utility.formatTemperature(high, isMetric) + "/" + app.com.example.andre.sunshine2.Utility.formatTemperature(low, isMetric);
        return highLowStr;
    }
